            ...
            <div class="card">
                <div class="card-body">
                    <div class="tab-content">
                        {{-- novalidate --}}
                        <form class="row needs-validation" method="POST" action="{{ route('updatePengguna') }}">
                            @csrf
                            ...
                            <div class="col-sm-6">
                                <div class="form-floating mb-3 card">
                                    <select class="form-select" id="floatingSelectGrid"
                                        ...
                                        <option value="0" @if ($user->level == 0) selected @endif>Staff (tidak bisa membuat pengguna
                                            baru)</option>
                                        <option value="1" @if ($user->level == 1) selected @endif>Admin (bisa membuat pengguna baru)
                                        </option>
                                        <option value="2" @if ($user->level == 2) selected @endif>Kepala Dinas (hanya bisa mengakses
                                            Agenda Kepala Dinas)
                                        </option>
                                    </select>
                            ...
                            <div class="col-sm-6">
                                <div class="form-floating mb-3 card">
                                    <input type="password" name="password" class="form-control" id="password"
                                        placeholder="" autocomplete="new-password" value="" onfocus="this.type='text'"
                            ...
                            <div class="col-sm-6">
                                <div class="form-floating mb-3 card">
                                    <input type="password" name="password_confirmation" class="form-control"
                                        id="password_confirmation" placeholder="" autocomplete="off" value=""
