                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8slot" style="max-width:50% !important;">
                            <div class="card" id="tooltip-container">
                                <a href="{{ route('arsipSKAll') }}" class="link-secondary"
                                    data-bs-container="#tooltip-container" data-bs-toggle="tooltip"
                                    title="Lihat semua surat keluar tahun {{ $tahun[0]->tahun }} - {{ $tahun[array_key_last($tahun)]->tahun }}">
                        ...
                        @foreach ($tahun as $t)
                            <div class="col-lg-8slot" style="max-width:50% !important;">
                                <div class="card" id="tooltip-container{{ $t->tahun }}">
                                    <a href="{{ route('arsipSKTahun', $t->tahun) }}" class="link-secondary"
